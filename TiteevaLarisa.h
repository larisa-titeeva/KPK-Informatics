...
//! <td>
//! @param x              x - координата центра головы лягушки
//! @param y              y - координата центра головы лягушки
//! @param Size           размер лягушки
//! @param MouthOpen      размер открытого рта (для квакания)</td></tr>
//! </table>
//!
//! @par        <b> Пример использования </b>
//! @code
