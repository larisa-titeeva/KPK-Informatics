...
//{--------------------------------------------------------------------------------------------------------
//! Íîâàÿ çâåçäà (ïî ñóòè êðóã ñ îïðåäåëåííîé çàëèâêîé)
//!
//! @param x         - x êîîðäèíàòà öåíòðà êðóãà (ïëàíåòû)
//! @param y         - y êîîðäèíàòà öåíòðà êðóãà (ïëàíåòû)
//! @param colorstar - öâåò ïëàíåòû. Çàäàåòñÿ ñòàíäàðòíûìè äëÿ <a href="http://storage.ded32.net.ru/Lib/TX/TXUpdate/Doc/HTML.ru/a00082.htm">TXlib </a> ñïîñîáàìè
//!
//! @par    Ïðèìåð:
//!
//! @code
...
//! @param sizeX     - çàäàåò ðàçìåðû çâåçäû ïî øèðèíå. Ìîæåò ïðèíèìàòü îòðèöàòåëüíûå è ïîëîæèòåëüíûå çíà÷åíèÿ.
//! @param sizeY     - çàäàåò ðàçìåðû çâåçäû ïî âûñîòå. Ìîæåò ïðèíèìàòü îòðèöàòåëüíûå è ïîëîæèòåëüíûå çíà÷åíèÿ.
//! @param colorST   - öâåò çâåçäû. Çàäàåòñÿ ñòàíäàðòíûìè äëÿ <a href="http://storage.ded32.net.ru/Lib/TX/TXUpdate/Doc/HTML.ru/a00082.htm">TXlib </a> ñïîñîáàìè
//! @par    Ïðèìåð:
//!
//! @code
...
//{--------------------------------------------------------------------------------------------------------
//! Ðèñóåò íå÷òî ïîäîáíîå ñòðîåíèþ Ñîëíå÷íîé ñèñòåìû. Äëÿ êàæäîé ïëàíåòû ðèñóåòñÿ îðáèòà ÷åðíîãî öâåòà, ñàìà ïëàíåòà âûáðàííîãî ðàäèóñà è öâåòà. (Äëÿ êàæäîé ïëàíåòû ðèñóåòñÿ ñâî¸ ñîëíöå â öåíòðå)
//!
//! @param x,y          - x è y êîîðäèíàòû îáùåãî öåíòðà
//! @param placeR       - çàäàåò ðàäèóñ îðáèòû äëÿ ïëàíåòû
//! @param PosPlanetX   - X öåíòðà ïëàíåòû
//! @param PosPlanetY   - Y öåíòðà ïëàíåòû
//! @param R            - ðàäèóñ ïëàíåòû
//! @param colorPL      - öâåò ïëàíåòû
//!
//! @par    Ïðèìåð:
//!
//! @code
...
//{--------------------------------------------------------------------------------------------------------
//! Ðèñóåò  òðàâó, ñîñòîÿùóþ èç òðåõ òðàâèíîê. Ñàìàÿ ãëàâíàÿ òî÷êà - âåðõóøêà ñðåäíåé òðàâèíêè.
//!
//! <img src="img/Grass.png">
//!
//! @param x,y          - x è y ëîãè÷åñêàÿ òî÷êà îòñ÷åòà
//! @param SizeX        - èçìåíÿåò øèðèíó êóñòà (îò -5...)
//! @param SizeY        - èçìåíÿåò âûñîòó êóñòà (îò -10 äî ëþáîãî ïàðàìåòðà... îñòîðîæíåå ñ æåëàíèÿìè)
//! @param wind         - ñìåùåíèå âåðõóøåê òðàâèíîê
//!
//! @par    Ïðèìåð:
//!
//! @code
...
//{--------------------------------------------------------------------------------------------------------
//! Åëî÷êà. Ðèñóåò  åëî÷êó èç òðåõ ÿðóñîâ ñ ñåðåäèíêàìè.
//!
//! <img src="img/Tree.png">
//!
//! @param x,y          - x è y ëîãè÷åñêàÿ òî÷êà îòñ÷åòà (ñåðåäèíà íèæíåé ãðàíèöû íèæíåãî ÿðóñà åëî÷êè)
//! @param SizeX        - èçìåíÿåò øèðèíó åëî÷êè (îò -10...)
//! @param SizeY        - èçìåíÿåò âûñîòó åëî÷êè (îò -10 äî ëþáîãî ïàðàìåòðà... îñòîðîæíåå ñ æåëàíèÿìè)
//! @param wind         - ñìåùåíèå âåðõóøåê ÿðóñîâ åëî÷êè
//!
//! @par    Ïðèìåð:
//!
//! @code
...
//{----------------------------------------------------------------------------------------------------------
//! Êîòèê.
//! Òðåóãîëüíûé êîòèê. Ïîñêîëüêó êîò æèâåò íà äðóãîé ïëàíåòå, óñîâ ó íåãî ïîêà íåò. <br>Çàòî óøè, ëàïû è õâîñò (íîñ è ãëàçà + çðà÷êè) ïðèñóòñòâóþò è ìîãóò âûðàæàòü íàñòðîåíèå êîòèêà
//!
//! <img src="img/Cat.png">
//!
//! @param x,y
...
//{----------------------------------------------------------------------------------------------------------
//! Ýòî ñöåíà. Ðèñóåò íîâóþ çâåçäó, ìåíÿþùóþ öâåò è óâåëè÷èâàþùóþñÿ â ðàçìåðàõ. Çàòåì ðèñóþòñÿ äðóã çà äðóãîì òðè âçðûâ÷èêà ðàçíûõ öâåòîâ è ðàçìåðîâ ñ íåáîëüøîé çàäåðæêîé ìåæäó íèìè.
//! È ñïîëüçóåò ïðîöåäóðû:  @ref DrawStarNew  è @ref DrawStarBang
//!
//! @par    Ïðèìåð:
//!
//!
